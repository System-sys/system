...
<body id="verify-account" class="h-screen bg-gradient-to-b from-slate-600 via-slate-800 to-[#1e2a36] text-slate-100 flex flex-col items-center justify-center relative overflow-hidden">
